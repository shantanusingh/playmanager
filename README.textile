...
Currently Play! Manager works clean on Windows. It is tested on Windows 7 (64-bit) and Windows Server 2008. It will work under Linux and Mac, but once you close stop Play! Manager, all applications started within Play! Manager will stop also.
